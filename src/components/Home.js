...
class Home extends Component {
    render() {
        return (
            <div className="home">
                <h1 style={{borderBottom: "2px solid"}}> My name is Jimmy Ren </h1>
                ...
                <p> I am currently a <b>sophomore </b> studying <b>Computer Science</b> in the School of Engineering and Applied Sciences at the <b>University of Pennsylvania </b>. Currently, I'm pursuing a minor in Data Science and
                    and obtaining a concentration in Artificial Intelligence. I'm originally from Naperville, Illinois, forty minutes outside of Chicago! 
                </p>
                <p>
